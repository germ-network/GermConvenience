...
Please report them using [Github Issues](https://github.com/germ-network/GermConvenience/issues)
...
Before opening a new issue, take a moment to [browse our existing issues](https://github.com/germ-network/GermConvenience/issues) to reduce the chance of reporting a duplicate.
